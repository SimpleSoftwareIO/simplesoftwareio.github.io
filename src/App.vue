      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          <div class="flex-shrink-0 flex items-center">
            <router-link to="/">
              <img class="block h-8 w-auto" src="/logo.svg" alt="Simple Software LLC" />
            </router-link>
          </div>
        ...
        <div class="-mr-2 flex items-center sm:hidden">
          <button @click="menuIsOpen = ! menuIsOpen" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
            <svg :class="menuIsOpen ? 'hidden' : 'block'" class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
            <svg :class="menuIsOpen ? 'block' : 'hidden'" class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
...
<router-link to="/docs/simple-sms" :class="linkState('simple-sms', true)" class="mt-1 block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out">
  ...
  <div class="py-10">
    <text-layout v-if="$route.meta.layout === 'text'" />
    <full-layout v-else />
  </div>
  ...
  <div class="bg-white">
    <div class="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      <nav class="-mx-5 -my-2 flex flex-wrap justify-center">
        ...
        <div class="px-5 py-2">
          <router-link to="/terms-of-use" class="text-base leading-6 text-gray-500 hover:text-gray-900">
            Terms of Use
          </router-link>
        </div>
        <div class="px-5 py-2">
          <router-link to="/privacy-policy" class="text-base leading-6 text-gray-500 hover:text-gray-900">
            Privacy Policy
          </router-link>
        </div>
      </nav>
      <div class="mt-8 flex justify-center">
        <a href="https://www.facebook.com/SimpleSoftwareIO" target="_blank" class="text-gray-400 hover:text-gray-500">
        ...
        <a href="https://www.twitter.com/_simplesoftware" target="_blank" class="ml-6 text-gray-400 hover:text-gray-500">
        ...
        <a href="https://github.com/SimpleSoftwareIO" target="_new" class="ml-6 text-gray-400 hover:text-gray-500">
      ...
      <div class="mt-8">
        <p class="text-center text-base leading-6 text-gray-400">
          &copy; 2014-2020 Simple Software LLC. All rights reserved.
        </p>
      </div>
    </div>
  </div>
...
export default {
  name: 'App',
  components: { TextLayout, FullLayout },
  data() {
    return {
      menuIsOpen: false,
    }
