    ...
    <nav class="bg-white shadow-sm">
          ...
          <div class="flex">
            ...
            <div class="hidden sm:ml-6 sm:flex">
              ...
              <router-link
                ...
                :class="linkState('simple-qrcode')"
                class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5  focus:outline-none focus:text-gray-700 transition duration-150 ease-in-out"
              >
                Simple-QrCode
              </router-link>
              <router-link
                to="/docs/simple-sms"
                :class="linkState('simple-sms')"
                class="ml-8 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5  focus:outline-none focus:text-gray-700 transition duration-150 ease-in-out"
              >
                Simple-SMS
              </router-link>
      ...
      >
        <div class="pt-2 pb-3">
          ...
          <router-link
            to="/docs/simple-qrcode"
            :class="linkState('simple-qrcode', true)"
            class="mt-1 block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out"
          >
            Simple-QrCode
          </router-link>
          <router-link
            to="/docs/simple-sms"
            :class="linkState('simple-sms', true)"
            class="mt-1 block pl-3 pr-4 py-2 border-l-4 border-transparent text-base font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300 transition duration-150 ease-in-out"
          >
            Simple-SMS
          </router-link>
      ...
      <div class="max-w-screen-xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav class="-mx-5 -my-2 flex flex-wrap justify-center">
          <div class="px-5 py-2 hidden sm:flex">
            <a
              href="https://medium.com/simple-software"
              target="_blank"
        ...
        <div class="mt-8 flex justify-center">
          <a
            href="https://www.facebook.com/SimpleSoftwareIO"
            target="_blank"
          ...
          <a
            href="https://www.twitter.com/_simplesoftware"
            target="_blank"
          ...
          <a
            href="https://github.com/SimpleSoftwareIO"
            target="_new"
            class="ml-6 text-gray-400 hover:text-gray-500"
          >
